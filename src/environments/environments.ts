export const environment = {
    ...
    assetsPath: '/assets2',
    apiGroveNfe: 'https://api.grovenfe.com.br',
    apiGroveNfeToken: 'oat_MQ.R2JqbDY5TGVsU3A1bVpzSmFPSk9FSWluY3RnSmo5UzR3SXhvT0NSMTQyMDU5NTc0MTM',
    // asaasUrl: 'https://.asaas.com/api/v3',
  
    // apiUrl: 'http://jason.com/api/v2/business',
    // apiUrlRequest: 'http://jason.com/api/v2/business',
    // apiLocalRequest: 'https://localhost:3334'
